...
/**
 * This class holds information about any license not on the SPDX license list, see
 * https://github.com/spdx/spdx-spec/blob/master/chapters/6-other-licensing-information-detected.md.
 *
...
data class SpdxExtractedLicenseInfo(
    ...
    init {
        require(extractedText.isNotBlank()) { "The extractedText must not be blank." }

        require(licenseId.isNotBlank()) { "The licenseId must not be blank." }
    }
}
